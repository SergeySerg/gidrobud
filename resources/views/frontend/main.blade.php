            ...
            <div class="row">
                ...
                @foreach($services as $service)
                    <div class="col-md-4 project-item_wrap">
                        <a href="services.html#{{ $service->id }}" class="project-item services-item">
                ...
                @endforeach
                <div class="col-md-4">
                    <a href="project.html"><div class="btn btn__blue btn__services">{{ trans('base.more') }}</div></a>
                </div>
            </div>
        </div>
    </div>
            ...
            @if( count($licenses) !== 0 AND $categories_data['licenses']->active == 1)
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <a href="license.html"><div class="btn btn__blue btn__center">{{ trans('base.all_licenses') }}</div></a>
                    </div>
                </div>
            @endif
